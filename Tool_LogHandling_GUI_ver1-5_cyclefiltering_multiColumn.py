...
class LogFilter:
    ...
    def choosecolumn(self):
        ...
        self.explain = Button(window3, text="Logging interval(ms)", command=lambda: self.inputinterval())
    ...
    def inputinterval(self):
        ...
        text = Label(getint, text="Logging interval(ms)")
    ...
    def getcomport(self):
        ...
        self.explain.configure(text=interval+" ms")
    ...
    def startcyclearrange(self, col, stepcol):
        ...
        for temp in range(len(loglists)):
            ...
            for m in col:
                ...
                try:
                    with pandas.ExcelWriter(savedirectory + "\\" + fn[0] + ".xlsx", mode='a') as writer:
                        cycle_df.to_excel(writer, float_format='%3f', sheet_name=m)
                except FileNotFoundError:
                    with pandas.ExcelWriter(savedirectory + "\\" + fn[0] + ".xlsx") as writer:
                        cycle_df.to_excel(writer, float_format='%3f', sheet_name=m)
